...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        tvSkip = (AutoTextView) hView.findViewById(R.id.tv_skip);
        tvDetail = (AutoTextView) hView.findViewById(R.id.tv_detail);
        tvTime = (AutoTextView) hView.findViewById(R.id.tv_time);
    ...
    public AutoTextView getTvSkipView() {
        return tvSkip;
    }

    public AutoTextView getTvDetailView() {
        return tvDetail;
    }

    public AutoTextView getTvTimeView() {
        return tvTime;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        if (page_indicatorId != null) { setPageIndicator(page_indicatorId); }
        cbLoopScaleHelper.setCurrentItem(canLoop ? mDatas.size() : cbLoopScaleHelper.getFirstItemPos());
    }
    ...
    /***
     * 设置倒计时
     * @param skipTime 倒计时时间
     * @return
     */
    public ConvenientBanner setSkipTime(long skipTime) {
