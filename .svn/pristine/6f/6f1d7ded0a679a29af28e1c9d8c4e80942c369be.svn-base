...
import com.hs.advertise.utils.Base64Utils;
...
public abstract class SignUtil {
    ...
    public static String getSign(Map<String, Object> params) {
        ...
        String sec = "";
        try {
            LogUtil.i("SignUtil ", "MyApplication.getInstance().getSn() " + MyApplication.getInstance().getSn());
            sec = Base64Utils.encode(secret + MyApplication.getInstance().getSn(), "utf-8");
