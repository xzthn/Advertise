...
class ProxyCache {
    ...
    protected void startWithCache() throws ProxyCacheException, IOException {
        if(!cache.isCompleted() && !stopped) {
            readSourceAsync();
        }
    }
...
//                    LogUtil.i("READ","readSource offset "+offset+ " LENGTH "+readBytes);
            ...
            LogUtil.i("READ", "readSource ex " + e.getMessage());
