...
public class HttpProxyCacheServer {
    ...
    public final Map<String, Long> crcCodeMap = new ConcurrentHashMap<>();
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            LogUtil.i("Proxy cache server started. Is it alive? " + isAlive());
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                LogUtil.d(TAG, "Accept new socket " + socket);
    ...
    private HttpProxyCacheServerClients getClients(String url) throws ProxyCacheException {
        synchronized (clientsLock) {
            ...
            if (clients == null) {
                ...
                clients.setCrccode(crcCodeMap.get(url));
    ...
    private void onError(Throwable e) {
        LogUtil.e("HttpProxyCacheServer error", e);
    }
    ...
    public static final class Builder {
        ...
        private boolean isOpenPlayAndCache = true;
        ...
        /**
         * set open play and Cache config
         *
         * @param isOpenPlayAndCache to set OpenPlayAndCache true or false
         * @return a builder
         */
        public Builder openPlayAndCache(boolean  isOpenPlayAndCache) {
            this.isOpenPlayAndCache = checkNotNull(isOpenPlayAndCache);
            return this;
        }
        ...
        private Config buildConfig() {
            return new Config(cacheRoot, fileNameGenerator, diskUsage, sourceInfoStorage, headerInjector,isOpenPlayAndCache);
        }
